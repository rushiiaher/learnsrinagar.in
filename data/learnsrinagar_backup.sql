...
INSERT INTO `blog_categories` VALUES (1,'Announcements','Official school updates like exam dates, holidays, results, etc.','2025-01-15 12:00:00'),(2,'Class Updates','Blogs or notices specific to classes (Class 6, 7, 8, etc.)','2025-01-15 12:00:00'),(3,'Achievements','Student or staff achievements, competitions, or awards','2025-01-15 12:00:00'),(4,'Events & Activities','Photos and write-ups about cultural events, sports day, etc.','2025-01-15 12:00:00'),(5,'Educational Articles','Informative blogs by teachers or experts on academic topics','2025-01-15 12:00:00'),(6,'Student Corner','Student-written blogs, stories, poems, etc.','2025-01-15 12:00:00'),(7,'Teacher Desk','Teacher reflections, tips, or classroom updates','2025-01-15 12:00:00'),(8,'Parent Information','Circulars, parenting tips, and important info for parents','2025-01-15 12:00:00'),(9,'Workshops & Seminars','Updates on training sessions or academic meets','2025-01-15 12:00:00');
...
CREATE TABLE `live_classes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `youtube_live_link` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `session_type` enum('subject_specific','other_topic') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'subject_specific',
  `topic_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `subject_id` int DEFAULT NULL,
  `class_id` int NOT NULL,
  ...
  `status` enum('upcoming','live','completed','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'upcoming',
  `is_active` tinyint(1) DEFAULT '1',
  `created_by_role` enum('super_admin','school_admin','teacher') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `approved_by` int DEFAULT NULL,
  `approval_status` enum('pending','approved','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'approved',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `subject_id` (`subject_id`),
...
-- Dump completed on 2026-03-09 18:24:37
